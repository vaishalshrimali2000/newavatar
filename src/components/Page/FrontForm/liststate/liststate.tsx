...
const ItemsTable = () => {
  ...
  const apiUrl = 'http://192.168.168.133:90/mst/getstates'; // Your API URL
  ...
  const handleDelete = () => {
    axios
      .post('http://192.168.168.133:90/mst/disablestate', {
    ...
    <CCard style={{ margin: '0', padding: '0' }}>
      {showForm ? (
        <ItemsCrudOperations
          ...
          itemDetails={selectedItem || { StateName: '', Description: '', SortOrder: '' }}
            ...
            <CTable>
              <CTableHead style={{ backgroundColor: '#DEDDF7' }}>
                <CTableRow>
                  ...
                  <CTableHeaderCell style={{ textAlign: 'start' }}>State Name</CTableHeaderCell>
              ...
              <CTableBody>
                {currentEntries.map((item) => (
                  <CTableRow key={item.StateID}>
                    <CTableDataCell style={{ textAlign: 'start' }}>{item.StateID}</CTableDataCell>
                    <CTableDataCell style={{ textAlign: 'start' }}>{item.StateName}</CTableDataCell>
