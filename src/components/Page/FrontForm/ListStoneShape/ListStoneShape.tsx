...
const apiUrl = process.env.NEXT_PUBLIC_API_URL;
  ...
  const handleDelete = () => {
    axios
      .post(`${apiUrl}/disablestoneshape`, {
        ShapeID: itemToDelete.ShapeID,
  ...
  const filteredData = data.filter(
    (item) =>
      item.ShapeID.toString().includes(searchTerm) ||
      item.StoneShape.toLowerCase().includes(searchTerm.toLowerCase())
  );
    ...
    <CCard style={{ margin: '0', padding: '0' }}>
      {showForm ? (
        <ItemsCrudOperations
          ...
          itemDetails={selectedItem || { StoneShape: '', SortOrder: '' }}
        ...
        <>
          ...
          >
            <strong>List Stone Shape</strong>
            ...
            <CTable>
              <CTableHead style={{ backgroundColor: '#DEDDF7' }}>
                <CTableRow>
                  ...
                  <CTableHeaderCell style={{ textAlign: 'start' }}>Stone Shape Name</CTableHeaderCell>
