...
const ItemsTable = () => {
  ...
  const apiUrl = 'http://192.168.168.133:90/mst/getcolors'; // Your API URL
  ...
  const handleDelete = () => {
    axios
      .post('http://192.168.168.133:90/mst/disablecolor', {
        ColorID: itemToDelete.ColorID,
  ...
  const filteredData = data.filter(
    (item) =>
      item.ColorID.toString().includes(searchTerm) ||
            ...
            <CTable>
              <CTableHead style={{ backgroundColor: '#DEDDF7' }}>
                <CTableRow>
                  ...
                  <CTableHeaderCell style={{ textAlign: 'start' }}>Color Name</CTableHeaderCell>
              ...
              <CTableBody>
                {currentEntries.map((item) => (
                  <CTableRow key={item.ColorID}>
                    <CTableDataCell style={{ textAlign: 'start' }}>{item.ColorID}</CTableDataCell>
                    <CTableDataCell style={{ textAlign: 'start' }}>{item.ColorName}</CTableDataCell>
