...
const apiUrl = process.env.NEXT_PUBLIC_API_URL;
  ...
  const handleDelete = () => {
    axios
      .post(`${apiUrl}/disablepptag`, {
        PPTagID: itemToDelete.PPTagID,
      ...
      .then(() => {
        ...
        // }, 1000);
        toast.success("PPTag deleted successfully!");
  ...
  const filteredData = data.filter(
    (item) =>
      item.PPTagID.toString().includes(searchTerm) ||
      item.PPTag.toLowerCase().includes(searchTerm.toLowerCase())
  );
    ...
    <CCard style={{ margin: '0', padding: '0' }}>
      {showForm ? (
        <ItemsCrudOperations
          ...
          itemDetails={selectedItem || { PPTag: '', SortOrder: '' }}
            ...
            <CTable>
              <CTableHead style={{ backgroundColor: '#DEDDF7' }}>
                <CTableRow>
                  ...
                  <CTableHeaderCell style={{ textAlign: 'start' }}>PPTag Name</CTableHeaderCell>
