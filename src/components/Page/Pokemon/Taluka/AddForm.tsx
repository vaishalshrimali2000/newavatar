...
const allCities = [
  "Agra", "Ahmedabad", "Bangalore", "Bhopal", "Chennai", "Delhi", "Hyderabad", "Jaipur", "Kolkata", "Mumbai",
  "Pune", "Surat", "Vadodara", "Visakhapatnam", "Nagpur", "Indore", "Coimbatore", "Bhubaneswar", "Chandigarh", "Guwahati",
              ...
              <CRow className="mb-4">
                <CCol md={12}>
                  <div className="form-group">
                    <CFormLabel htmlFor="stateSelect" className="form-label">Select District:</CFormLabel>
                    <CFormSelect
                      id="stateSelect"
                  ...
                  <CCol md={6}>
                    <div className="city-item" style={{ height: '50px', backgroundColor: 'rgb(233, 236, 239)', margin: '5px 0', borderRadius: '5px', display: 'flex', alignItems: 'center' }}>
                      <div className="form-group mb-4" style={{ marginTop: '30px' }}>
                        ...
                        />
                        <CFormLabel htmlFor="selectAllCities" className="form-check-label">Select All Taluka</CFormLabel>
                      </div>
                    </div>
                    <CFormInput
                      type="text"
                    ...
                    <div className="city-item" style={{ height: '50px', backgroundColor: 'rgb(233, 236, 239)', margin: '5px 0', borderRadius: '5px', display: 'flex', alignItems: 'center' }}>
                      <div className="form-group mb-4" style={{ marginTop: '30px' }}>
                        <CFormCheck
                          ...
                          className="form-check-input rounded-checkbox"
                        />
                        <CFormLabel htmlFor="removeAllCities" className="form-check-label">Remove All Taluka</CFormLabel>
                      </div>
                    </div>
                    <CFormInput
                      type="text"
