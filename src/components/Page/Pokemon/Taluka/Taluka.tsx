...
//     (item) =>
//       item.TalukaID.toString().includes(searchTerm) ||
//       item.TalukaName.toLowerCase().includes(searchTerm.toLowerCase())
//   );
...
//           itemDetails={selectedItem || { TalukaName: '', Description: '', SortOrder: '' }}
...
//               <CButton
//                 color="primary"
//                 onClick={() => handleOpenForm()} // Open the form for adding new Taluka
...
//                   <CTableHeaderCell style={{ textAlign: 'start' }}>Taluka Name</CTableHeaderCell>
...
//                   <CTableRow key={item.TalukaID}>
//                     <CTableDataCell style={{ textAlign: 'start' }}>{item.TalukaID}</CTableDataCell>
//                     <CTableDataCell style={{ textAlign: 'start' }}>{item.TalukaName}</CTableDataCell>
...
//         </CModalBody>
//         <CModalFooter>
//           <CButton color="primary" onClick={() => setShowSuccessModal(false)}>OK</CButton>
//         </CModalFooter>
//       </CModal>
//     </CCard>
//   );
