...
const ItemsTable = () => {
  ...
  const apiUrl = 'http://192.168.168.133:90/mst/getcategories'; // Your API URL
  ...
  const handleDelete = () => {
    axios
      .post('http://192.168.168.133:90/mst/disablecategory', {
    ...
    <CCard style={{ margin: '0', padding: '0' }}>
      {showForm ? (
        <ItemsCrudOperations
          ...
          itemDetails={selectedItem || { CategoryName: '', Description: '', SortOrder: '' }}
            ...
            <CTable>
              <CTableHead style={{ backgroundColor: '#DEDDF7' }}>
                <CTableRow>
                  ...
                  <CTableHeaderCell style={{ textAlign: 'start' }}>Category Name</CTableHeaderCell>
              ...
              <CTableBody>
                {currentEntries.map((item) => (
                  <CTableRow key={item.CategoryID}>
                    <CTableDataCell style={{ textAlign: 'start' }}>{item.CategoryID}</CTableDataCell>
                    <CTableDataCell style={{ textAlign: 'start' }}>{item.CategoryName}</CTableDataCell>
